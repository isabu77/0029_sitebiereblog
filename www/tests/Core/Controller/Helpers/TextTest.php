...
class TextControllerTest extends TestCase
{
    ...
    {
        $text = "Esse nostrud sunt id tempor amet eiusmod anim."
        ." Esse nostrud sunt id tempor amet eiusmod anim. Esse nostrud sunt id tempor amet eiusmod anim.";
        $this->assertEquals(
    ...
    {
        $text = "Esse nostrud sunt id tempor amet eiusmod anim."
        ." Esse nostrud sunt id tempor amet eiusmod anim. Essen ostrud sunt id tempor amet eiusmod anim.";
        $this->assertEquals(
    ...
    {
        $text = "<h1>Esse nostrud sunt</h1> <p>id tempor amet eiusmod anim."
        ."</p> <section>Esse nostrud sunt id tempor amet eiusmod anim."
        ." Esse nostrud sunt id tempor amet eiusmod anim.</section>";
        $this->assertEquals(
            'Esse nostrud sunt id tempor amet eiusmod anim.'
            .' Esse nostrud sunt id tempor amet eiusmod anim. Esse nostrud...',
            TextController::excerpt($text)
